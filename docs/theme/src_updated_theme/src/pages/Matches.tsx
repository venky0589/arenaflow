...
const columns: GridColDef[] = [
  ...
  { field: 'score1', headerName: 'Score 1', width: 80 },
  { field: 'score2', headerName: 'Score 2', width: 80 },
      ...
      return (
        <MatchActionsMenu
          match={{
            ...
            player1Id: params.row.player1?.id,
            player1Name: params.row.player1?.firstName && params.row.player1?.lastName
              ? `${params.row.player1.firstName} ${params.row.player1.lastName}`
              : undefined,
            player2Id: params.row.player2?.id,
            player2Name: params.row.player2?.firstName && params.row.player2?.lastName
              ? `${params.row.player2.firstName} ${params.row.player2.lastName}`
              : undefined
          }}
          compact
        />
...
export function Matches() {
  const { matches, loading, page, size: pageSize, totalElements, fetchMatches, createMatch, updateMatch, deleteMatch, setPage, setSize } = useMatchStore()
        ...
        <Stack spacing={2} sx={{ mt: 1 }}>
          ...
          <FormControl fullWidth disabled={saving}>
            ...
            >
              ...
              <MenuItem value="READY_TO_START">READY TO START</MenuItem>
